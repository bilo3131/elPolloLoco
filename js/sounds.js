const sounds = [
    ...
    bottle_splash = new Audio('assets/audio/bottleSplash.mp3'),
    damage_sound = new Audio('assets/audio/characterDamage.mp3'),
    jump_sound = new Audio('assets/audio/jump.mp3'),
    win_sound = new Audio('assets/audio/win.mp3'),
    lose_sound = new Audio('assets/audio/lose.mp3'),
